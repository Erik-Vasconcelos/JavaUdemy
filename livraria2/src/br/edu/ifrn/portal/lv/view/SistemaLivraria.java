package br.edu.ifrn.portal.lv.view;
...
public class SistemaLivraria {
	public static void main(String[] args) throws SQLException {
		...
		Livro livro1 = new LivroInformatica("Java como programar", "Paul deitel",360.45, 5668L);
		Livro livro2 = new LivroInformatica("Codigo Limpo", "Robert c.", 71.56, 8792L);
		
		Estante estante2 = new Estante(10, 2L);
		Livro livro3 = new LivroInformatica("Uml", "Grady Booch",124.09, 2575L);
		Livro livro4 = new LivroInformatica("Design Patterns", "Gang of four", 92.65, 4582L);
		
		Estante estante3 = new Estante(2, 3L);
		Livro livro5 = new LivroInformatica("Domain Drive design", "Eric Evans",82.14, 6787L);
		Livro livro6 = new LivroInformatica("Refatoração", "Martin Fowler", 95.55, 6569L);
		
		Estante estante4 = new Estante(15, 4L);
		Livro livro7 = new LivroInformatica("Algoritmo", "Ronald L.",308.85, 5715L);
		Livro livro8 = new LivroInformatica("Ajax", "Rebecca M.", 80.56, 6482L);
		...
		Livro livro9 = new LivroInformatica("Html e css", "Use a cabeça", 124.78, 3545L);
		estante4.inserirLivro(livro9);
		
		Livro livro10 = new LivroInformatica("Jpa", "Hebert coelho", 154.87, 6445L);
		try {
